        ...
        <div class="row justify-content-center">
            <div class="col-md-8">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form name="my-form" onsubmit="return validform()" action="insertNewRecord.jsp" method="post">
                                <div class="form-group row">
...
<section>
  ...
  <div class="tbl-content">
    ...
    <hr class="new1">
  <center><h5>Note: Any errors occur then contact BAI Tech Days.
Designed & Developed by BAI Tech Days Team</h5></center>
  <hr class="new1">
<center><h5>All Right Reserved @ BAI Tech Days :: 2014-Ongoing</h5></center> 
  <hr class="new1">
<br>
</body>
</html>